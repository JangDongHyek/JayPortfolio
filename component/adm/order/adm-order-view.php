    ...
    <div v-if="load">
        <div class="container py-5">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <select class="form-select form-select-sm" style="max-width:200px;" v-model="row.status" @change="$postData(row,{return : true})">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <p><strong>이름:</strong> {{row.$user__name}}</p>
                            <p><strong>연락처:</strong> {{row.$user__phone}}</p>
                            <p><strong>이메일:</strong> {{row.$user__email}}</p>
                            <p><strong>주소:</strong> ({{row.$user__zipcode}}) {{row.$user__address1}} {{row.$user__address2}}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-end gap-2">
                <button class="btn btn-secondary" @click="$jd.lib.href('/adm?component=adm-order-list')">목록으로</button>
            </div>
        </div>
